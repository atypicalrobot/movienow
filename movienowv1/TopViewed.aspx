<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TopViewed.aspx.cs" Inherits="movienowv1._Default" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
     <div class="header">
        <h1 class="text-center">Top Viewed</h1>
    </div>
    <div class="row-fluid" >
        <div class="col-md-2">
